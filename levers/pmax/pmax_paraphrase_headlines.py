...
class PMAXHeadlineParaphrase(Lever):

    @Lever.log_generate
    def generate(self) -> None:

        ## Detect Language
        self.input_dict['language'] = detect_language(self.input_dict['reference_headline'])
...
Reference Headline: Pure And Natural Hair Oil
...
Additional Reference: Revive Your Hair With Mamaearth Hair Oil. Get healthy, luscious hair with Mamaearth’s natural hair oil

Write 6 Variations of the Reference Headline. All Variations should have less than 6 words.
All Variations must be in English.

Variation 1: Natural Hair Oil By Mamaearth
Variation 2: Safe And Natural Hair Oil
Variation 3: Toxin-Free, Pure Hair Oil
Variation 4: Get Shiny, Healthy Hair Now
Variation 5: Get Glossy Hair With Mamaearth
Variation 6: Gentle Hair Oil For All
...
if __name__ == '__main__':
    ...
    ids = {
            ...
            "brand_name": "Vuori",
            "theme": "cashback",
            "reference_headline" : "Quer milhas, cashback, desconto na fatura",
    ...
    gens, logs = PMAXHeadlineParaphrase().run(ids)
    print(gens)
    # print(logs)
